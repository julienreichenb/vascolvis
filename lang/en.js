export default {
  ...
  layout: {
    atelier: 'My Atelier',
    rcso: 'The VASCO project is a HES-SO initiative.'
  },
  index: {
    ...
    sample: {
      button: 'Create charts',
      buttonannot: 'See annotations'
    },
    error: {
  ...
  about: {
    ...
    p_2:
      "The charts generated by the tool are simple, because they serve an exploratory purpose, not in-depth analysis. During the next implementations, it could be possible to create more elaborated charts. Vasco is using the chart library <a href='https://vega.github.io/vega-lite-v1/' target='_blank'>Vega-Lite</a>.",
    title_3: 'Chart annotation',
    p_3:
      'The second goal of Vasco is to allow collaboration around the data exploration, by using the colVis plugin, developed aside in the context of a PhD thesis of the Human-IST institute (Fribourg University). The plugin allows to highlight a graph part and to annotate it or to attach a comment to an existing annotation, to encourage discussions around the potential findings.',
    title_4: 'The Team',
    p_4:
      '<strong>Prof. Florian Evéquoz</strong> - Project manager & initiator <br />' +
      '<strong>Miriam Luque Chipana</strong> - MAS on Vasco (UNIFR) & Development of the project prequel <br />' +
